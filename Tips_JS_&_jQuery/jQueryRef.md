...
Inside the folder using_this, you can see a working example, which you can run [here](https://cdn.rawgit.com/bruno-oliveira/theodinprojectExercises/tree/master/Tips_JS_%26_jQuery/using_this), that illustrates the desired functionality.
